...
| :---    | :-------:      |  :-----------:  | ----: |
| Kotlin    | Firebase Authentication   |   |  Android Studio  |
|  Jetpack Compose  | Cloud Firestore   |   |  VS Code |
|   Dart  |  Ktor      |  Provider       | GitBash   |
| Flutter | MongoDB |||
| NodeJS  |   Supabase     |     Riverpod      |  Git & GitHub  |
| ExpressJS  |        |     BloC      | ChatGPT   |  
|        |     Isar    |    GetX             |    Gemini AI     |
