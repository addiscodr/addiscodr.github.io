...
7. [<font color="black"><em>Movie Booking</em> - Node JS, Flutter, Stripe, HTTP, Firebase Auth, Firebase Cloud Firestore</font>](https://github.com/addiscodr/addis_ecommerce){:target="_blank"}
